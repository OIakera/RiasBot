...
async def reedme(event):
    await event.edit(
        ...
        "\n[Rias UB's' README.md file](https://github.com/akirasup3r/RiasBot/blob/staging/README.md)"
)
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click here](https://github.com/akirasup3r/RiasBot) to open Rias UB's GitHub Repo."
    )
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "[Click here](https://heroku.com/deploy?template=https://github.com/akirasup3r/RiasBot/tree/staging) to deploy Rias Userbot on Heroku."
    )

@register(outgoing=True, pattern="^.support$")
async def grup(sapot):
    await sapot.edit("**Github:** https://github.com/akirasup3r/RiasBot")
...
".guide"
"\nUsage: Provides Full guide to setup Rias Userbot.\n\n"
".repeat <no.> <text>"
...
".deploy"
"\nUsage: Get link to deploy Rias Userbot on Heroku."
     }
)
